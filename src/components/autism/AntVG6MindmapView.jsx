...
const API_BASE = 'https://api-digitalsymphony.ngrok.pizza/api/';
...
const TreeEvent = { COLLAPSE_EXPAND: 'collapse-expand', ADD_CHILD: 'add-child' };
let textShape;
...
export default function AntVG6MindmapView({endpoint}) {
  ...
  useEffect(() => {
    ...
    // Load the data as in the original example
    ...
    //                                   {
    //                                     id: nanoid(),
    //                                     label: "Lorem Ipsum Dolor Sit Amet Consec Lorem Ipsum Dolor Sit Amet Consec "
    //                                   }
    //                                 ]
    //                               },
    //                             ]
